...
<template>
    ...
    >
        ...
        >
            ...
            <a
                href="/auth/google"
                class="mt-6 flex items-center justify-center gap-2 border border-brand-100 rounded-md py-2.5 text-sm font-medium text-brand-900 hover:bg-brand-50/50 transition-colors"
            >
